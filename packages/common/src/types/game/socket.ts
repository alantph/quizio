import type {
  ...
  Player,
  QuizzWithId,
} from "@quizio/common/types/game";
import type { Status, StatusDataMap } from "@quizio/common/types/game/status";
