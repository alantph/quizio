import type { CommonStatusDataMap } from "@quizio/common/types/game/status"
import CricleCheck from "@quizio/web/features/game/components/icons/CricleCheck"
import CricleXmark from "@quizio/web/features/game/components/icons/CricleXmark"
import { usePlayerStore } from "@quizio/web/features/game/stores/player"
import { SFX_RESULTS_SOUND } from "@quizio/web/features/game/utils/constants"
