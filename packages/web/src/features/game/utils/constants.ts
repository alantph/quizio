import Answers from "@quizio/web/features/game/components/states/Answers";
import ManagerSelectAnswer from "@quizio/web/features/game/components/states/ManagerSelectAnswer";
import Leaderboard from "@quizio/web/features/game/components/states/Leaderboard";
import Podium from "@quizio/web/features/game/components/states/Podium";
import Prepared from "@quizio/web/features/game/components/states/Prepared";
import Question from "@quizio/web/features/game/components/states/Question";
import Responses from "@quizio/web/features/game/components/states/Responses";
import Result from "@quizio/web/features/game/components/states/Result";
import Room from "@quizio/web/features/game/components/states/Room";
import Start from "@quizio/web/features/game/components/states/Start";
import Wait from "@quizio/web/features/game/components/states/Wait";

import { STATUS } from "@quizio/common/types/game/status";
import Circle from "@quizio/web/features/game/components/icons/Circle";
import Rhombus from "@quizio/web/features/game/components/icons/Rhombus";
import Square from "@quizio/web/features/game/components/icons/Square";
import Triangle from "@quizio/web/features/game/components/icons/Triangle";
...
export const GAME_STATE_COMPONENTS_MANAGER = {
  ...
  [STATUS.SELECT_ANSWER]: ManagerSelectAnswer,
